...
#define FT5206_RST_GPIO_PIN             SYS_GPIO_PIN11
#define FT5206_RST_GPIO_CLK_ENABLE()    do{ RCC->APB2ENR |= 1 << 7; }while(0)   /* PF口时钟使能 */

#define FT5206_INT_GPIO_PORT            GPIOF
#define FT5206_INT_GPIO_PIN             SYS_GPIO_PIN10
#define FT5206_INT_GPIO_CLK_ENABLE()    do{ RCC->APB2ENR |= 1 << 7; }while(0)   /* PF口时钟使能 */
