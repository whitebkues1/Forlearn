...
#define T_PEN_GPIO_PIN                  SYS_GPIO_PIN10
#define T_PEN_GPIO_CLK_ENABLE()         do{ RCC->APB2ENR |= 1 << 7; }while(0)   /* 所在IO口时钟使能 */

#define T_CS_GPIO_PORT                  GPIOF
#define T_CS_GPIO_PIN                   SYS_GPIO_PIN11
#define T_CS_GPIO_CLK_ENABLE()          do{ RCC->APB2ENR |= 1 << 7; }while(0)   /* 所在IO口时钟使能 */

#define T_MISO_GPIO_PORT                GPIOB
#define T_MISO_GPIO_PIN                 SYS_GPIO_PIN2
#define T_MISO_GPIO_CLK_ENABLE()        do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* 所在IO口时钟使能 */

#define T_MOSI_GPIO_PORT                GPIOF
#define T_MOSI_GPIO_PIN                 SYS_GPIO_PIN9
#define T_MOSI_GPIO_CLK_ENABLE()        do{ RCC->APB2ENR |= 1 << 7; }while(0)   /* 所在IO口时钟使能 */

#define T_CLK_GPIO_PORT                 GPIOB
#define T_CLK_GPIO_PIN                  SYS_GPIO_PIN1
#define T_CLK_GPIO_CLK_ENABLE()         do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* 所在IO口时钟使能 */
