...
void oled_init(void)
{
    ...
    sys_gpio_set(GPIOC, 0XFF,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PC0 ~ 7 设置 */

    sys_gpio_set(GPIOD, SYS_GPIO_PIN3 | SYS_GPIO_PIN6,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PD3, PD6 设置 */

    sys_gpio_set(GPIOG, SYS_GPIO_PIN13 | SYS_GPIO_PIN14 | SYS_GPIO_PIN15,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* PG13, PG14, PG15 设置 */
    ...
    sys_gpio_set(OLED_SPI_RST_PORT, OLED_SPI_RST_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* RST引脚模式设置 */

    sys_gpio_set(OLED_SPI_CS_PORT, OLED_SPI_CS_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* CS引脚模式设置 */

    sys_gpio_set(OLED_SPI_RS_PORT, OLED_SPI_RS_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* RS引脚模式设置 */

    sys_gpio_set(OLED_SPI_SCLK_PORT, OLED_SPI_SCLK_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* SCLK引脚模式设置 */

    sys_gpio_set(OLED_SPI_SDIN_PORT, OLED_SPI_SDIN_PIN,
                 SYS_GPIO_MODE_OUT, SYS_GPIO_OTYPE_PP, SYS_GPIO_SPEED_MID, SYS_GPIO_PUPD_PU);   /* SDIN引脚模式设置 */
