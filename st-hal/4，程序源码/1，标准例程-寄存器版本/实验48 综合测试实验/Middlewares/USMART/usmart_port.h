 ...
 */
#define USMART_TIMX                     TIM2
#define USMART_TIMX_IRQn                TIM2_IRQn
#define USMART_TIMX_IRQHandler          TIM2_IRQHandler
#define USMART_TIMX_CLK_ENABLE()        do{ RCC->APB1ENR |= 1 << 0; }while(0)   /* TIMX 时钟使能 */
