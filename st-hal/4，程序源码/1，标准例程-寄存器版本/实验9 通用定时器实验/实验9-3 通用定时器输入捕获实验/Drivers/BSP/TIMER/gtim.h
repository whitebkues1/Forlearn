...
#define GTIM_TIMX_PWM_CHY_GPIO_CLK_ENABLE() do{ RCC->APB2ENR |= 1 << 3; }while(0)   /* PB口时钟使能 */
 ...
 */
#define GTIM_TIMX_PWM_CHY_GPIO_REMAP()      sys_gpio_remap_set(10, 2, 2)            /* 通道REMAP设置, 该函数不是必须的, 根据需要实现 */
