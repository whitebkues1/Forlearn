 ...
 * 实验名称：SD卡 实验
 * 实验平台：正点原子 精英F103开发板
 * 实验目的：学习STM32的SDMMC接口的使用,并驱动SD卡
 ...
 ***************************************************************************************************
 * 实验现象
 * 1 本实验开机的时候先初始化SD卡，如果SD卡初始化完成，则提示LCD初始化成功。
     按下KEY0，读取SD卡扇区0的数据，然后通过串口发送到电脑。如果没初始化通过，则在LCD上提示初始化失败。
 * 2 LED0闪烁 ,提示程序运行。
