...
uint8_t jpg_decode(const char *filename, uint8_t fast);                          /* JPEG/JPG解码函数 */
uint8_t jpg_get_size(const uint8_t *filename, uint32_t *width, uint32_t *height);   /* 获取JPEG/JPG图片分辨率 */
